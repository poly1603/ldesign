...
engine.use(createI18nPlugin({
  ...
  messages: {
    en: {
      app: {
        title: 'Angular Engine Example',
        description: 'A demo application showcasing @ldesign/engine integration with Angular',
        welcome: 'Welcome to Angular + Engine'
      },
      features: {
    ...
    zh: {
      app: {
        title: 'Angular 引擎示例',
        description: '展示 @ldesign/engine 与 Angular 集成的演示应用',
        welcome: '欢迎使用 Angular + Engine'
      },
      features: {
        i18n: '国际化',
        theme: '主题切换',
