declare module 'vue' {
  ...
  export const watchEffect: (effect: () => void, options?: unknown) => void
  export const unref: <T>(ref: T) => T extends { value: infer V } ? V : T
  export const toRef: <T>(object: T, key: keyof T) => { value: T[keyof T] }
  ...
  export const provide: <T>(key: unknown, value: T) => void

  // 生命周期
  export const onMounted: (hook: () => void) => void
  export const onUnmounted: (hook: () => void) => void
  export const onBeforeMount: (hook: () => void) => void
  export const onBeforeUnmount: (hook: () => void) => void
  export const onUpdated: (hook: () => void) => void
  export const onBeforeUpdate: (hook: () => void) => void
  ...
  export const createApp: (rootComponent: unknown, rootProps?: unknown) => App
  ...
  export const TransitionGroup: unknown
  ...
  export interface MaybeRef<T = unknown> {
    value?: T
  }
