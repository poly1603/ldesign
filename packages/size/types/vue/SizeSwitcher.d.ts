import { JSX } from '../node_modules/.pnpm/vue@3.5.18_typescript@5.9.2/node_modules/vue/jsx-runtime/index.d.js'
 ...
 * 尺寸切换器组件
 */
declare const SizeSwitcher: DefineComponent<
  ExtractPropTypes<{
    mode: {
 ...
 * 尺寸指示器组件
 */
declare const SizeIndicator: DefineComponent<
  ExtractPropTypes<{
    showMode: {
      type: BooleanConstructor
      default: boolean
 ...
 * 尺寸控制面板组件
 */
declare const SizeControlPanel: DefineComponent<
  ExtractPropTypes<{
    showSwitcher: {
      type: BooleanConstructor
      default: boolean
