    ...
    <div class="demo-grid">
      ...
      <div class="demo-card">
        ...
        <div class="demo-actions">
          <button class="btn btn-secondary" @click="previousMode">上一个</button>
        ...
        <div class="switcher-demo">
          <div class="mode-buttons">
            <button 
              ...
              :key="mode"
              :class="['mode-btn', { active: switcherCurrentMode === mode }]"
      ...
      <div class="demo-card">
        ...
        <div class="custom-manager">
          ...
          <div class="demo-actions">
            <button class="btn btn-primary" @click="customSetMode('small')">小</button>
            <button class="btn btn-primary" @click="customSetMode('medium')">中</button>
            <button class="btn btn-primary" @click="customSetMode('large')">大</button>
          </div>
