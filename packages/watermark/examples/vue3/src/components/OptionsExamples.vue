  ...
  <div class="options-examples">
    ...
    <div class="grid grid-2">
      ...
      <div class="card glass">
        ...
        <div class="form-group">
          ...
          <input v-model="basicConfig.fontSize" type="range" min="12" max="32">
        </div>
        <div class="demo-container" ref="basicContainer">
        ...
        <div class="controls">
          <button class="btn btn-primary" @click="createBasicWatermark">创建水印</button>
          <button class="btn btn-danger" @click="destroyBasicWatermark">销毁水印</button>
        </div>
      ...
      <div class="card glass">
        ...
        <div class="demo-container" ref="lifecycleContainer">
          <div class="demo-content">
            <p>生命周期钩子示例</p>
      ...
      <div class="card glass">
        ...
        <div class="form-group">
          <label>部门</label>
          <input v-model="userInfo.department" type="text" placeholder="输入部门">
        </div>
        <div class="info-display">
          <p>计算的水印内容: {{ computedWatermarkText }}</p>
        </div>
        <div class="demo-container" ref="computedContainer">
          <div class="demo-content">
            <p>计算属性示例</p>
            <p>水印内容根据用户信息自动计算</p>
          </div>
        ...
        <div class="controls">
          <button class="btn btn-primary" @click="updateComputedWatermark">更新水印</button>
        </div>
        <div class="code-preview">
          <details>
            <summary>查看代码</summary>
      ...
      <div class="card glass">
        ...
        <div class="demo-container" ref="watchContainer">
          <div class="demo-content">
            <p>侦听器示例</p>
            <p>主题变化时自动更新水印样式</p>
          </div>
    ...
    <div class="card glass mt-30">
      ...
      <div class="grid grid-2">
        <div>
          <h4>混入组件 A</h4>
          <div class="demo-container" ref="mixinContainerA">
            <div class="demo-content">
          ...
          <div class="controls">
            <button class="btn btn-primary" @click="createMixinWatermarkA">创建</button>
            <button class="btn btn-danger" @click="destroyMixinWatermarkA">销毁</button>
          </div>
        </div>
        
        <div>
          <h4>混入组件 B</h4>
          <div class="demo-container" ref="mixinContainerB">
            <div class="demo-content">
              <p>使用 watermarkMixin</p>
              <p>状态: {{ mixinStatusB }}</p>
            </div>
          ...
          <div class="controls">
            <button class="btn btn-primary" @click="createMixinWatermarkB">创建</button>
            <button class="btn btn-danger" @click="destroyMixinWatermarkB">销毁</button>
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async createLifecycleWatermark() {
      ...
      try {
        this.lifecycleInstance = await createWatermark(this.$refs.lifecycleContainer, {
    ...
    async updateComputedWatermark() {
      ...
      try {
        this.computedInstance = await createWatermark(this.$refs.computedContainer, {
    ...
    async createMixinWatermarkA() {
      ...
      try {
        this.mixinInstanceA = await createWatermark(this.$refs.mixinContainerA, {
          content: 'Mixin A',
          style: {
            fontSize: 14,
    ...
    async createMixinWatermarkB() {
      ...
      try {
        this.mixinInstanceB = await createWatermark(this.$refs.mixinContainerB, {
          content: 'Mixin B',
          style: {
            fontSize: 14,
