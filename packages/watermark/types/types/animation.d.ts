 ...
 * 动画相关类型定义
 */
type AnimationType = 'none' | 'rotate' | 'move' | 'fade' | 'pulse' | 'scale' | 'bounce' | 'swing';
type EasingFunction = 'linear' | 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | 'cubic-bezier' | ((t: number) => number);
...
export { DEFAULT_ANIMATION_CONFIG };
export type { AnimationConfig, AnimationDirection, AnimationEvents, AnimationFillMode, AnimationInstance, AnimationParams, AnimationPlayState, AnimationType, EasingFunction };
