...
interface DOMRenderer extends BaseRenderer {
    readonly type: 'dom';
    /** 创建水印元素 */
...
interface CanvasRenderer extends BaseRenderer {
...
interface SVGRenderer extends BaseRenderer {
    readonly type: 'svg';
    /** SVG元素 */
    svg: SVGSVGElement;
    /** 创建SVG元素 */
...
export type { BaseRenderer, CanvasRenderer, DOMRenderer, ImageLoader, LayoutResult, RenderCache, RenderContext, RenderEvents, RenderOptions, RenderPerformance, RendererConfig, RendererFactory, SVGRenderer };
