...
import { BaseRenderer, RenderContext } from './render.js';
...
type WatermarkInstanceState = 'creating' | 'active' | 'paused' | 'updating' | 'destroying' | 'destroyed';
...
export type { BatchOperationOptions, CreateInstanceOptions, InstanceEvents, InstanceManager, InstanceQuery, InstanceStats, UpdateInstanceOptions, WatermarkInstance, WatermarkInstanceState };
