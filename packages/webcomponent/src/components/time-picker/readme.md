...
| `disabledHours`   | `disabled-hours`   |              | `number[]`                                                                                                                                                           | `undefined`                   |
| `disabledMinutes` | `disabled-minutes` |              | `number[]`                                                                                                                                                           | `undefined`                   |
| `disabledSeconds` | `disabled-seconds` |              | `number[]`                                                                                                                                                           | `undefined`                   |
...
| `locale`          | `locale`           |              | `TimePickerLocale`                                                                                                                                                   | `undefined`                   |
