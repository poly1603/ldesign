...
| `cancelType`           | `cancel-type`            |                                                | `"danger" \| "dashed" \| "gradient" \| "link" \| "outline" \| "primary" \| "secondary" \| "success" \| "text" \| "warning"` | `'secondary'`  |
...
| `okType`               | `ok-type`                |                                                | `"danger" \| "dashed" \| "gradient" \| "link" \| "outline" \| "primary" \| "secondary" \| "success" \| "text" \| "warning"` | `'primary'`    |
