...
function initKeyGenerationHandlers() {
  ...
  generateSaltBtn.addEventListener('click', async () => {
    try {
      ...
      const length = parseInt(document.getElementById('salt-length').value)
  ...
  generateIVBtn.addEventListener('click', async () => {
    try {
      ...
      const length = parseInt(document.getElementById('iv-length').value)
  ...
  generateAllBtn.addEventListener('click', async () => {
    try {
      ...
      const saltLength = parseInt(document.getElementById('salt-length').value)
      const ivLength = parseInt(document.getElementById('iv-length').value)
