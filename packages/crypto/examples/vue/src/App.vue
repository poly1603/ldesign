      ...
      <div class="card">
        ...
        <div class="grid">
          <div>
            ...
            <button @click="generateCryptoKey" class="btn">生成随机密钥</button>
          </div>
          <div>
      ...
      <div class="card">
        ...
        <div class="grid">
          <div>
            ...
            <button @click="handleHashAll" :disabled="isHashing" class="btn">
              计算所有算法
            </button>
          </div>
          <div>
            <div v-if="hashResult" class="result" data-testid="hash-result">
              <div class="result-label">{{ selectedHashAlgorithm }} 哈希结果:</div>
              <div>{{ hashResult }}</div>
            </div>
            <div v-if="allHashResults.length" class="result">
              <div class="result-label">所有哈希结果:</div>
      ...
      <div class="card">
        ...
        <div class="grid">
          <div>
            ...
            <button @click="generateKeyPair" :disabled="isSigning" class="btn">
              生成 RSA 密钥对
            </button>
            <button 
              @click="handleSign" 
          ...
          <div>
            <div v-if="keyPair" class="result">
              <div class="result-label">RSA 密钥对已生成</div>
              <div>密钥长度: 2048 位</div>
            </div>
            <div v-if="signature" class="result">
              <div class="result-label">数字签名:</div>
              <div style="word-break: break-all;">{{ signature }}</div>
            </div>
            <div v-if="verificationResult !== null" class="result" :class="{ success: verificationResult }">
              <div class="result-label">签名验证:</div>
      ...
      <div class="card">
        ...
        <div class="grid">
          <div>
            ...
            <button @click="testPlugin" class="btn">测试插件功能</button>
          </div>
          <div>
            <div v-if="pluginResult" class="result success">
              <div class="result-label">插件测试结果:</div>
