...
describe('Dilithium Signatures', () => {
  ...
  describe('Signing and Verification', () => {
    ...
    it('should handle large messages', () => {
      ...
      const isValid = dilithium.verify(largeMessage, signature.signature, keyPair.publicKey);
      expect(isValid).toBe(true);
    });
  });

  describe('Performance', () => {
    it('should be faster than SPHINCS+', () => {
      ...
      // Dilithium should be significantly faster
      expect(dilithiumTime).toBeLessThan(sphincsTime);
    });
  });
});
...
describe('Interoperability', () => {
  ...
  it('should serialize and deserialize signatures', () => {
    ...
    const isValid = sphincs.verify(message, deserialized, keyPair.publicKey);
    expect(isValid).toBe(true);
  });
});
