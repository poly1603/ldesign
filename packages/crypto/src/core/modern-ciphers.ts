...
export class Poly1305 {
  ...
  constructor(key: Uint8Array) {
    ...
    this.r = new Array(5).fill(0n);
    this.h = new Array(5).fill(0n);
    this.pad = new Array(4).fill(0n);
    this.leftover = 0;
...
export class ModernCipherUtils {
   ...
   */
  static generateKey(algorithm: 'chacha20' | 'xsalsa20' | 'blake2b' = 'chacha20'): Uint8Array {
