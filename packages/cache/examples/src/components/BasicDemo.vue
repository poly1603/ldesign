  ...
  <div class="demo-card">
    ...
    <div class="demo-section">
      ...
      <input
        ...
        "
      />
      <button @click="setCache" class="btn">设置缓存</button>
    </div>
    ...
    <div class="demo-section">
      ...
      <input
        ...
        "
      />
      <button @click="getCache" class="btn">获取缓存</button>
    ...
    <div class="demo-section">
      <h4>TTL 演示</h4>
      <button @click="setTTLCache" class="btn">设置5秒过期缓存</button>
      <button @click="checkTTLCache" class="btn secondary">检查TTL缓存</button>
    ...
    <div class="demo-section">
      <h4>批量操作</h4>
      <button @click="setBatchCache" class="btn">批量设置</button>
      <button @click="getAllKeys" class="btn secondary">获取所有键</button>
      <button @click="clearAllCache" class="btn danger">清空缓存</button>
