 ...
 */
declare function debounce<T extends (...args: unknown[]) => unknown>(func: T, wait: number, immediate?: boolean): (...args: Parameters<T>) => void;
/**
 * 高性能节流函数
 * @param func - 要节流的函数
 * @param wait - 等待时间（毫秒）
 ...
 */
declare function throttle<T extends (...args: unknown[]) => unknown>(func: T, wait: number, options?: {
    leading?: boolean;
    trailing?: boolean;
 ...
 */
declare function getScreenOrientation(width?: number, height?: number): Orientation;
/**
...
declare function safeNavigatorAccess<K extends keyof Navigator>(property: K, fallback?: Navigator[K]): Navigator[K] | undefined;
/**
 * 格式化字节大小
 */
