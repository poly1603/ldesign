import { Ref, Directive, Plugin } from 'vue';
...
export { BatteryModule, DeviceDetector, DevicePlugin, EventEmitter, GeolocationModule, ModuleLoader, NetworkModule, cleanupGlobalDetector, createDevicePlugin, DevicePlugin as default, useBattery, useDevice, useDeviceDetector, useGeolocation, useNetwork, vDevice, vDeviceDesktop, vDeviceMobile, vDeviceTablet };
export type { BatteryInfo, DeviceDetectorEvents, DeviceDetectorOptions, DeviceDirectiveValue, DeviceInfo, DeviceModule, DevicePluginOptions, DeviceType, EventListener, GeolocationInfo, ModuleLoader$1 as IModuleLoader, NetworkInfo, NetworkStatus, NetworkType, Orientation, UseDeviceReturn };
