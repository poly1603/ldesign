...
/** 登录数据联合类型 */
type LoginData = UsernameLoginData | PhoneLoginData;
/** 图片验证码配置 */
...
/** LoginPanel 组件 Props */
interface LoginPanelProps extends LoginPanelConfig {
    /** 加载状态 */
    loading?: boolean;
    /** 是否禁用 */
    disabled?: boolean;
...
export type { CaptchaConfig, CountdownState, FieldValidation, LoginData, LoginEvent, LoginMode, LoginPanelConfig, LoginPanelEvents, LoginPanelProps, LoginPanelState, ModeChangeEvent, PhoneLoginData, SmsCodeConfig, ThemeChangeEvent, ThemeColors, ThemeConfig, ThemeEffect, ThemeMode, ThirdPartyLoginConfig, UsernameLoginData, ValidationErrors, ValidationRule };
