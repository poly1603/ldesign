...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/data-search-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 25 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M2.22632 2H22.2263V11H2.22632V2ZM8.22827 6.5H6.22437V8.50391H8.22827V6.5Z" [attr.fill]="color" />
    <path
...
export class DataSearchFilledComponent {
