...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/system-components',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <g id="system-components">
        <path id="fill1" d="M11.9994 9.75L15.8484 12V16.5L11.9994 18.75L8.15039 16.5V12L11.9994 9.75Z" [attr.fill]="color" />
        <g id="fill2">
            <path
