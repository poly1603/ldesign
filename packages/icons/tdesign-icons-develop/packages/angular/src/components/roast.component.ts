...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/roast',
  template: `
...
<path id="fill2" d="M10 14H14V17H10V14Z" [attr.fill]="color"/>
...
<path id="stroke2" d="M17 10H15M9 10H7M10 14H14V17H10V14Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
