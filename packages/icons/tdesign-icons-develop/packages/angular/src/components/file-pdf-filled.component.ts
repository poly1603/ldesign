...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/file-pdf-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M8 15.2496V14.0002L8.75003 14.0001V15.2494L8 15.2496Z" [attr.fill]="color" />
    <path d="M13.5 14.0005L14.25 14.0003V17.9999L13.5 18.0003V14.0005Z" [attr.fill]="color" />
    <path
        ...
        [attr.fill]="color" />
    <path d="M21 14L19 14.0005V15.2497H21V14Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class FilePdfFilledComponent {
