...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/calm-1',
  template: `
...
<path id="stroke2" d="M17 10H16M16 10H15M16 10V12M9 10H8M8 10H7M8 10V12M12 15H12.0039V15.0039H12V15Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
