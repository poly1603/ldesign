...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/system-search-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M3 20H12.0837C12.4181 20.7486 12.8849 21.4252 13.4542 22H3V20Z" [attr.fill]="color" />
    <path
...
export class SystemSearchFilledComponent {
