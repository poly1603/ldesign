...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/system-blocked-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M3 20H11.9596C12.2404 20.734 12.6411 21.4087 13.1379 22H3V20Z" [attr.fill]="color" />
    <path
...
export class SystemBlockedFilledComponent {
