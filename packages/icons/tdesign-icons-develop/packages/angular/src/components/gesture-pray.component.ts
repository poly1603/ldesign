...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-pray',
  template: `
    ...
    <g id="gesture-pray">
        <path id="fill1"
            ...
            [attr.fill]="color" />
        <g id="fill2">
            <path d="M19.2039 15.71L15.0884 19.8255L17.1461 21.8832L21.2616 17.7677L19.2039 15.71Z" [attr.fill]="color" />
...
export class GesturePrayComponent {
