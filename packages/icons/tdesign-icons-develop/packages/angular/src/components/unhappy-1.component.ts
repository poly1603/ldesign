...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/unhappy-1',
  template: `
...
<path id="stroke2" d="M17 10H15M9 10H7M8.53516 16C9.22678 14.8044 10.5195 14 12 14C13.4806 14 14.7733 14.8044 15.4649 16" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class Unhappy1Component {
