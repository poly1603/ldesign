...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/arrow-right-up-circle',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
<g id="arrow-right-up-circle">
...
<path id="stroke2" d="M15.1638 14.4569V8.8H9.50692M14.2799 9.68387L8.7998 15.164" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ArrowRightUpCircleComponent {
