...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/sneer',
  template: `
...
<path id="stroke2" d="M17 10H15M9 10H7M15.5 14.5C15.056 16.2252 13.8638 17 12 17" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
