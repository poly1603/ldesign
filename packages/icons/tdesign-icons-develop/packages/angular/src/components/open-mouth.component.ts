...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/open-mouth',
  template: `
...
<path id="fill2" d="M8 14H16V17H8V14Z" [attr.fill]="color"/>
...
<path id="stroke2" d="M16 9V11M8 9V11M8 14H16V17H8V14Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class OpenMouthComponent {
