...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/speechless-1',
  template: `
...
<path id="stroke2" d="M17 10H15M7 10L10 10V16H13" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class Speechless1Component {
