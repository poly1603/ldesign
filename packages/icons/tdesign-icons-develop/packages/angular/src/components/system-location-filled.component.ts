...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/system-location-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M3 20H11.75V22H3V20Z" [attr.fill]="color" />
    <path
...
export class SystemLocationFilledComponent {
