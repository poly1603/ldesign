...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/contrast',
  template: `
...
<path id="fill2" d="M12 18.5C15.5899 18.5 18.5 15.5899 18.5 12C18.5 8.41015 15.5899 5.5 12 5.5V18.5Z" [attr.fill]="color"/>
...
<path id="stroke2" d="M12 18.5C15.5899 18.5 18.5 15.5899 18.5 12C18.5 8.41015 15.5899 5.5 12 5.5V18.5Z" [attr.stroke]="color" stroke-[attr.width]="size"/>
</g>
</svg>
