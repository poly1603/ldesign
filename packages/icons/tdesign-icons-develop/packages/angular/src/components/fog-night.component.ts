...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/fog-night',
  template: `
    ...
    <g id="fog-night">
        ...
        <path id="stroke2" d="M3 18H7M3 22H14M18 22H21M11 18H21" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class FogNightComponent {
