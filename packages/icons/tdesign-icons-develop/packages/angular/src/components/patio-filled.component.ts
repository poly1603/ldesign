...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/patio-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M11 22V20H9V22H11Z" [attr.fill]="color" />
    <path d="M11 18H9V16.5H11V18Z" [attr.fill]="color" />
    <path d="M11 14.5H9V13H11V14.5Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class PatioFilledComponent {
