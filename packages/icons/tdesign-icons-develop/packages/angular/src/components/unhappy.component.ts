...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/unhappy',
  template: `
...
<path id="stroke2" d="M16 9V11M8.53516 16C9.22678 14.8044 10.5195 14 12 14C13.4806 14 14.7733 14.8044 15.4649 16M8 9V11" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
