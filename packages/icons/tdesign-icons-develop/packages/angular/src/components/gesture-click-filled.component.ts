...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-click-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M10 3.91421V0.5H12V3.91421H10Z" [attr.fill]="color" />
    <path d="M7.41436 5.49917L5.00015 3.08496L3.58594 4.49917L6.00015 6.91339L7.41436 5.49917Z" [attr.fill]="color" />
    <path
        ...
        [attr.fill]="color" />
    <path d="M16.9998 3.08496L14.5856 5.49917L15.9998 6.91339L18.4141 4.49917L16.9998 3.08496Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class GestureClickFilledComponent {
