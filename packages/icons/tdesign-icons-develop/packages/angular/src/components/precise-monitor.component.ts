...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/precise-monitor',
  template: `
    ...
    <g id="precise-monitor">
        ...
        <path id="stroke2" d="M4 20L8.5 15.5M12 7V3M8.5 8.5L4 4M15.5 8.5L20 4M17 12H21M20 20L15.5 15.5M12 21V17"
            [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
    </g>
</svg>
  `,
...
export class PreciseMonitorComponent {
