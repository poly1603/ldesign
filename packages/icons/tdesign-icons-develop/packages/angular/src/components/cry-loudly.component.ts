...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/cry-loudly',
  template: `
...
<path id="stroke2" d="M12 14V15M17 10H16M16 10H15M16 10V14M9 10H8M8 10H7M8 10V14" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class CryLoudlyComponent {
