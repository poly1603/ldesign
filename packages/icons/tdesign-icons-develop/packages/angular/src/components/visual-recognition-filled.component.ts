...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/visual-recognition-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M24 16V14H16V16H19V23H21V16H24Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class VisualRecognitionFilledComponent {
