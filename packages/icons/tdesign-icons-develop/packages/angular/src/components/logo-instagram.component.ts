...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/logo-instagram',
  template: `
    ...
    <g id="logo-instagram">
        ...
        <g id="stroke2">
            <path d="M17.75 6.25H17.7539V6.25391H17.75V6.25Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linejoin="round" />
            <path
                d="M16.5 12C16.5 14.4853 14.4853 16.5 12 16.5C9.51472 16.5 7.5 14.4853 7.5 12C7.5 9.51472 9.51472 7.5 12 7.5C14.4853 7.5 16.5 9.51472 16.5 12Z"
                [attr.stroke]="color" stroke-[attr.width]="size" stroke-linejoin="round" />
        </g>
    </g>
</svg>
  `,
