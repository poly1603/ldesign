...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/browse-off',
  template: `
    ...
    <g id="browse-off">
        ...
        <path id="stroke2" d="M20.9996 21L3 3" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
    </g>
</svg>
  `,
  standalone: true
})
export class BrowseOffComponent {
