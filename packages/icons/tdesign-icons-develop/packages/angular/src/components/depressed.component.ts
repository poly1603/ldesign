...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/depressed',
  template: `
...
<path id="stroke2" d="M16.8668 10.5L15.1348 9.5M8.86682 9.5L7.13477 10.5M8.53516 16C9.22678 14.8044 10.5195 14 12 14C13.4806 14 14.7733 14.8044 15.4649 16" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class DepressedComponent {
