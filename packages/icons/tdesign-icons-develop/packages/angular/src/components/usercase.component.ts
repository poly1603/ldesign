...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/usercase',
  template: `
    ...
    <g id="usercase">
        ...
        <path id="stroke2" d="M10.5 8H11.5M10.5 16H11.5" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
    </g>
</svg>
  `,
  standalone: true
})
export class UsercaseComponent {
