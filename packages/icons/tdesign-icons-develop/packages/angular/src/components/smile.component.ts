...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/smile',
  template: `
...
<path id="stroke2" d="M8 9V11M16 9V11M8.53516 15C9.22678 16.1956 10.5195 17 12 17C13.4806 17 14.7733 16.1956 15.4649 15" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
