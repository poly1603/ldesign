...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/sleep',
  template: `
...
<path id="stroke2" d="M17 9.5C17 10.3284 16.3284 11 15.5 11C14.6716 11 14 10.3284 14 9.5M10 9.5C10 10.3284 9.32843 11 8.5 11C7.67157 11 7 10.3284 7 9.5M12 15H12.0039V15.0039H12V15Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
