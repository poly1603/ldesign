...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/happy',
  template: `
...
<path id="stroke2" d="M8 9V11M16 9V11M16 14C16 16.2091 14.2091 18 12 18C9.79086 18 8 16.2091 8 14H16Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
