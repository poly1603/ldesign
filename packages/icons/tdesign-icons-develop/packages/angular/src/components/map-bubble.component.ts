...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/map-bubble',
  template: `
    ...
    <g id="map-bubble">
        ...
        <path id="stroke1" d="M3 6.5V20L9 17.5L15 21L21 17.5V4L15 6.5L9 3L3 6.5Z" [attr.stroke]="color" stroke-[attr.width]="size" />
        <g id="stroke2">
            <path
                d="M14.75 10.25C14.75 10.6642 14.4142 11 14 11C13.5858 11 13.25 10.6642 13.25 10.25C13.25 9.83579 13.5858 9.5 14 9.5C14.4142 9.5 14.75 9.83579 14.75 10.25Z"
