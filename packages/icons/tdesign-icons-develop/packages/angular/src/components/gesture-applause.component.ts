...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-applause',
  template: `
    ...
    <g id="gesture-applause">
        ...
        <g id="fill2">
            <path d="M19.2044 15.71L15.0889 19.8255L17.1466 21.8832L21.2621 17.7677L19.2044 15.71Z" [attr.fill]="color" />
            <path d="M4.79408 15.71L8.90959 19.8255L6.85184 21.8832L2.73633 17.7677L4.79408 15.71Z" [attr.fill]="color" />
        </g>
        <path id="stroke1"
        ...
        <path id="stroke2" d="M4 3L3 2M4 7L3 8M20 3L21 2M20 7L21 8" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class GestureApplauseComponent {
