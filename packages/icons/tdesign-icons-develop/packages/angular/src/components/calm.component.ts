...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/calm',
  template: `
...
<path id="stroke2" d="M16 9V11M8 9V11M15 15H11.5" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
