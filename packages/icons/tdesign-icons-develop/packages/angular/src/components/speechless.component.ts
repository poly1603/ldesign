...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/speechless',
  template: `
...
<path id="stroke2" d="M17 10H15M9 10H7M14 15H10" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class SpeechlessComponent {
