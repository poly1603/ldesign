...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/cloudy-sunny',
  template: `
    ...
    <g id="cloudy-sunny">
        ...
        <g id="stroke2">
            ...
            <path d="M10.0561 4.05168L10.0536 4.05416L10.0508 4.05136L10.0533 4.04887L10.0561 4.05168Z" [attr.stroke]="color"
                stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M15.0005 2L15.004 2V2.00396L15.0005 2.00396V2Z" [attr.stroke]="color" stroke-[attr.width]="size"
                stroke-linecap="square" />
            <path d="M19.9517 4.04886L19.9542 4.05135L19.9514 4.05415L19.9489 4.05166L19.9517 4.04886Z" [attr.stroke]="color"
                stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M22.0045 9.00003V9.00355H22.0005V9.00003H22.0045Z" [attr.stroke]="color" stroke-[attr.width]="size"
                stroke-linecap="square" />
        </g>
        <path id="stroke1"
            d="M2 16.5333C2 18.4479 3.61178 20 5.6 20H15.5C17.9853 20 20 18.0599 20 15.6667C20 14.0605 19.0926 12.6585 17.7445 11.91C17.0838 11.5432 16.3174 11.3333 15.5 11.3333C15.4751 11.3333 15.4502 11.3335 15.4254 11.3339C15.0716 9.30141 13.4933 7.66861 11.4459 7.16281C11.0157 7.05652 10.5647 7 10.1 7C7.11766 7 4.7 9.32812 4.7 12.2C4.7 12.5261 4.73117 12.8451 4.79079 13.1546C3.19223 13.5082 2 14.8867 2 16.5333Z"
...
export class CloudySunnyComponent {
