...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-typing-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M4 0C2.89543 0 2 0.89543 2 2C2 3.10457 2.89543 4 4 4C5.10457 4 6 3.10457 6 2C6 0.89543 5.10457 0 4 0Z"
        [attr.fill]="color" />
    <path
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M4 6C2.89543 6 2 6.89543 2 8C2 9.10457 2.89543 10 4 10C5.10457 10 6 9.10457 6 8C6 6.89543 5.10457 6 4 6Z"
        [attr.fill]="color" />
    <path
...
export class GestureTypingFilledComponent {
