...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/curtain-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 21.9999V8.62515C2.90587 9.30584 4.02447 9.71972 5.23964 9.7484L6.98987 21.9999H2Z" [attr.fill]="color" />
    <path
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M17.0101 21.9999L18.7604 9.7484C19.9755 9.71972 21.0941 9.30584 22 8.62515V21.9999H17.0101Z"
        [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class CurtainFilledComponent {
