...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/translate-1',
  template: `
    ...
    <g id="translate-1">
        ...
        <path id="stroke2" d="M21 21L16.5 11.5L12 21M19.55 19H13.45" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class Translate1Component {
