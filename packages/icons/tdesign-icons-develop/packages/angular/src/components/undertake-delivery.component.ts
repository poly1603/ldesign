...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/undertake-delivery',
  template: `
    ...
    <g id="undertake-delivery">
        <path id="fill1"
            ...
            [attr.fill]="color" />
        <g id="fill2">
            <path d="M4.5 15.25V20.5H1V15.25H4.5Z" [attr.fill]="color" />
            <path d="M16.5 3H12.5V8L14.5 7L16.5 8V3Z" [attr.fill]="color" />
        </g>
        <path id="stroke1"
        ...
        <path id="stroke2" d="M8.5 8.5V3H20.5V10.5M12.5 3H16.5V8L14.5 7L12.5 8V3Z" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class UndertakeDeliveryComponent {
