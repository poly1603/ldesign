...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/city-ancient-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M2 13L22 13L22 15L21 15L21 22H16V17H8V22H3.00001L3 15H2V13Z" [attr.fill]="color" />
    <path d="M10 22V19H14V22H10Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class CityAncientFilledComponent {
