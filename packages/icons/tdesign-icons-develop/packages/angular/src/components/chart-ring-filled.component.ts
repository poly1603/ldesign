...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/chart-ring-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M22.9995 11.8954V12.1049C22.9998 12.07 23 12.0351 23 12.0001C23 11.9652 22.9998 11.9303 22.9995 11.8954Z"
        [attr.fill]="color" />
    <path
        ...
        [attr.fill]="color" />
    <path d="M19.8501 19.7057L19.7056 19.8502C19.7542 19.8025 19.8024 19.7543 19.8501 19.7057Z" [attr.fill]="color" />
    <path
...
export class ChartRingFilledComponent {
