...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/rice-ball',
  template: `
    ...
    <g id="rice-ball">
        ...
        <g id="stroke2">
            <path d="M9.2959 10.1865H9.29942V10.1905H9.2959V10.1865Z" [attr.stroke]="color" stroke-[attr.width]="size" />
            <path d="M11.998 6.12793H12.0016V6.13189H11.998V6.12793Z" [attr.stroke]="color" stroke-[attr.width]="size" />
            <path d="M14.7007 10.1875H14.7042V10.1915H14.7007V10.1875Z" [attr.stroke]="color" stroke-[attr.width]="size" />
        </g>
    </g>
</svg>
  `,
...
export class RiceBallComponent {
