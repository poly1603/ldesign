...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/markup',
  template: `
    ...
    <g id="markup">
        <path id="fill1"
            ...
            [attr.fill]="color" />
        <g id="fill2">
            <path d="M7 20.6622C8.47087 21.513 10.1786 22 12 22C13.8214 22 15.5291 21.513 17 20.6622L15 13H9L7 20.6622Z"
                [attr.fill]="color" />
            <path d="M10.9999 9V13H12.9999V9L11.9999 8L10.9999 9Z" [attr.fill]="color" />
        </g>
        <path id="stroke2"
