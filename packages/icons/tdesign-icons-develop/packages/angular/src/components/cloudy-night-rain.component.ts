...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/cloudy-night-rain',
  template: `
    ...
    <g id="cloudy-night-rain">
        ...
        <g id="stroke2">
            ...
            <path d="M12.9961 14.9766H13V14.9805H12.9961V14.9766Z" [attr.stroke]="color" stroke-[attr.width]="size"
                stroke-linecap="square" />
            <path d="M13 19.9766H13.0039V19.9805H13V19.9766Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M8 16.9766H8.00391V16.9805H8V16.9766Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M8 21.9766H8.00391V21.9805H8V21.9766Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
        </g>
        <path id="stroke1"
...
export class CloudyNightRainComponent {
