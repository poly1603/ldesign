...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/user-talk-off-1',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <g id="user-talk-off-1">
        <path id="stroke1"
        ...
        <path id="stroke2" d="M21 21L3 3" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
    </g>
</svg>
  `,
  standalone: true
})
export class UserTalkOff1Component {
