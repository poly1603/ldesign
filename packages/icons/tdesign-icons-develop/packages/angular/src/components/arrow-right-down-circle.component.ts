...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/arrow-right-down-circle',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
<g id="arrow-right-down-circle">
...
<path id="stroke2" d="M15.1638 9.50712V15.164H9.50692M14.2799 14.2801L8.7998 8.8" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ArrowRightDownCircleComponent {
