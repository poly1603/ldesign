...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/ferocious',
  template: `
...
<path id="fill2" d="M15 14L8 15.3333L15 16V14Z" [attr.fill]="color"/>
...
<path id="stroke2" d="M16.8668 9.5L15.1348 10.5M8.86682 10.5L7.13477 9.5M8 15.3333L15 14V16L8 15.3333Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class FerociousComponent {
