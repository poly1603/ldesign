...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/shutter-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M14.8091 1.36241L11.4983 7.20403L21.9016 7.20403C20.5176 4.3516 17.9368 2.1862 14.8091 1.36241Z"
        [attr.fill]="color" />
    <path
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M9.21356 22.6441L12.5151 16.7944H2.09693C3.48413 19.6549 6.07466 21.8248 9.21356 22.6441Z" [attr.fill]="color" />
    <path
...
export class ShutterFilledComponent {
