...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/fact-check',
  template: `
...
<path id="stroke2" d="M6 8L10 8M18.5 10.5L15 14L13.5 12.5M6 12H10M6 16H10" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
