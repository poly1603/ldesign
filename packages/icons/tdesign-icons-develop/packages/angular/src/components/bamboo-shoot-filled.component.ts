...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/bamboo-shoot-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M8.25565 7.10869L15.0666 8.54479L14.0251 3.93558C12.3215 4.66642 10.3728 5.68621 8.25565 7.10869Z"
        [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class BambooShootFilledComponent {
