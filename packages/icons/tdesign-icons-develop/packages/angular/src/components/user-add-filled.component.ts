...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/user-add-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M23 19H19V23H17V19H13V17H17V13H19V17H23V19Z" [attr.fill]="color" />
    <path
...
export class UserAddFilledComponent {
