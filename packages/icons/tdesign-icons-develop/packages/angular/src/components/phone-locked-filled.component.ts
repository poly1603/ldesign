...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/phone-locked-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M20 1H4V23H11.5V17H6V3H18V11.0205C18.7087 11.079 19.3826 11.2607 20 11.544V1Z" [attr.fill]="color" />
    <path
...
export class PhoneLockedFilledComponent {
