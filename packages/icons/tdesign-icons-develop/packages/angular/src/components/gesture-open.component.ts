...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-open',
  template: `
    ...
    <g id="gesture-open">
        <path id="fill1"
            ...
            [attr.fill]="color" />
        <g id="fill2">
            <path d="M21 20.1458L13.783 20.1456L13.2508 16.9734L19.0815 15.1885L21 15.1887V20.1458Z" [attr.fill]="color" />
            <path d="M3 20.1458L10.217 20.1456L10.7492 16.9734L4.91846 15.1885L3 15.1887L3 20.1458Z" [attr.fill]="color" />
        </g>
        <g id="stroke1">
            <path
            ...
            <path
                ...
                [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M21 20.1458L13.783 20.1456L13.2508 16.9734L19.0815 15.1885L21 15.1887V20.1458Z" [attr.stroke]="color"
                stroke-[attr.width]="size" stroke-linecap="square" />
            <path d="M3 20.1458L10.217 20.1456L10.7492 16.9734L4.91846 15.1885L3 15.1887L3 20.1458Z" [attr.stroke]="color"
                stroke-[attr.width]="size" stroke-linecap="square" />
        </g>
    </g>
</svg>
...
export class GestureOpenComponent {
