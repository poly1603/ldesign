...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/bug',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <g id="bug">
        <g id="fill1">
            <path d="M17 9H7V16C7 18.7614 9.23858 21 12 21C14.7614 21 17 18.7614 17 16V9Z" [attr.fill]="color" />
            <path d="M12 2C9.79086 2 8 3.79086 8 6H16C16 3.79086 14.2091 2 12 2Z" [attr.fill]="color" />
        </g>
        <path id="stroke1"
