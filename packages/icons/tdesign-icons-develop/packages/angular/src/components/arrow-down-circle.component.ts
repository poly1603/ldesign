...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/arrow-down-circle',
  template: `
...
<path id="stroke2" d="M8 13.1L12 17.1L16 13.1M12 15.85V6.85001" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ArrowDownCircleComponent {
