...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/arrow-left-down-circle',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
<g id="arrow-left-down-circle">
...
<path id="stroke2" d="M8.7998 9.50712V15.164H14.4567M9.68367 14.2801L15.1638 8.8" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ArrowLeftDownCircleComponent {
