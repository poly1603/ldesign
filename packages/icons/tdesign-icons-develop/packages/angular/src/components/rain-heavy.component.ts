...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/rain-heavy',
  template: `
    ...
    <g id="rain-heavy">
        ...
        <path id="stroke2" d="M7.99805 14.002V18M11.998 12.002V20M15.998 14.002V18" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class RainHeavyComponent {
