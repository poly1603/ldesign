...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/castle-6-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M19.3333 14C20.8061 14 22 15.1939 22 16.6667V22H16.6667V16.6667C16.6667 15.1939 17.8606 14 19.3333 14Z"
        [attr.fill]="color" />
    <path
        d="M14.6667 16.6667V22H9.33333V16.6667C9.33333 15.1939 10.5272 14 12 14C13.4728 14 14.6667 15.1939 14.6667 16.6667Z"
        [attr.fill]="color" />
    <path d="M7.33333 16.6667V22H2V16.6667C2 15.1939 3.19391 14 4.66667 14C6.13943 14 7.33333 15.1939 7.33333 16.6667Z"
        [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class Castle6FilledComponent {
