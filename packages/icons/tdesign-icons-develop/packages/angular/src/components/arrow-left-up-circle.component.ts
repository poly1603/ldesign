...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/arrow-left-up-circle',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
<g id="arrow-left-up-circle">
...
<path id="stroke2" d="M8.7998 14.4569V8.8H14.4567M9.68366 9.68387L15.1638 15.164" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ArrowLeftUpCircleComponent {
