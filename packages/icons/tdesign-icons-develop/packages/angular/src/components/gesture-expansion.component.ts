...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/gesture-expansion',
  template: `
    ...
    <g id="gesture-expansion">
        ...
        <path id="stroke2" d="M7 1H10V4M3 5V8H6M9.39896 1.60105L3.7421 7.2579" [attr.stroke]="color" stroke-[attr.width]="size"
...
export class GestureExpansionComponent {
