...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/member-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_101749_96975)">
        <path
            ...
            [attr.fill]="color" />
        <path d="M5 14C2.23858 14 0 16.2386 0 19V21H17V19C17 16.2386 14.7614 14 12 14H5Z" [attr.fill]="color" />
        <path
...
export class MemberFilledComponent {
