...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/look-around',
  template: `
...
<path id="stroke2" d="M12 9V11M8 9V11M10 15H10.0039V15.0039H10V15Z" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class LookAroundComponent {
