...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/palace-3-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M9.5 19.5C9.5 17 12 15.5 12 15.5C12 15.5 14.5 17 14.5 19.5V22H9.5V19.5Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class Palace3FilledComponent {
