...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/translate',
  template: `
    ...
    <g id="translate">
        ...
        <path id="stroke2" d="M13 4.5H18C19.1046 4.5 20 5.39543 20 6.5V8M5 14V19C5 20.1046 5.89543 21 7 21H8.5"
            [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square" />
    </g>
</svg>
  `,
