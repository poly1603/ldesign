...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/dvd-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path
        d="M22 2V22H2V2H22ZM12 6C8.68629 6 6 8.68629 6 12C6 15.3137 8.68629 18 12 18C15.3137 18 18 15.3137 18 12C18 8.68629 15.3137 6 12 6Z"
        [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class DvdFilledComponent {
