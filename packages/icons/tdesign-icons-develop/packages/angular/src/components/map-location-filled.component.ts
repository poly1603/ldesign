...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/map-location-filled',
  template: `
    <svg [attr.width]="size" [attr.height]="size" viewBox="0 0 24 24" [attr.fill]="color" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.5 2.71741L2 5.92575V21.5001L7.5 19.2328V2.71741Z" [attr.fill]="color" />
    <path d="M9.5 18.9097L11.25 19.9432V16.75C11.25 14.3035 12.5516 12.161 14.5 10.9771V5.09051L9.5 2.1377V18.9097Z"
        [attr.fill]="color" />
    <path
...
export class MapLocationFilledComponent {
