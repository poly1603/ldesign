...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/chat-bubble-history',
  template: `
...
<path id="stroke2" d="M12 6.5V12L15 15" [attr.stroke]="color" stroke-[attr.width]="size" stroke-linecap="square"/>
</g>
</svg>
...
export class ChatBubbleHistoryComponent {
