...
@Component({
  selector: 'tdesign-tdesign-icons-develop/svg/rain-light-filled',
  template: `
    ...
    <path
        ...
        [attr.fill]="color" />
    <path d="M6.99805 18.998H9.00195V21.002H6.99805V18.998Z" [attr.fill]="color" />
    <path d="M14.998 18.998H17.002V21.002H14.998V18.998Z" [attr.fill]="color" />
    <path d="M13.002 20.998H10.998V23.002H13.002V20.998Z" [attr.fill]="color" />
</svg>
  `,
  standalone: true
})
export class RainLightFilledComponent {
