<template>
  <div class="tablet-login-template">
      ...
      <form class="login-form" @submit.prevent="handleSubmit">
        <div class="form-row">
          <div class="form-group">
            <label for="main-tablet-username">用户名</label>
            <input
              id="main-tablet-username"
          ...
          <div class="form-group">
            <label for="main-tablet-password">密码</label>
            <input
              id="main-tablet-password"
