...
exports.resolveInputPatterns = resolveInputPatterns;
exports.normalizeInput = normalizeInput;
exports.getOutputDirs = getOutputDirs;
...
async function resolveSinglePattern(pattern, rootDir) {
    ...
    if (!containsGlobPattern(pattern)) {
        return path_1.default.resolve(rootDir, pattern);
    }
    // 使用 glob 解析通配符
...
async function normalizeInput(input, rootDir = process.cwd()) {
    if (!input) {
        // 默认入口
        return path_1.default.resolve(rootDir, 'src/index.ts');
    }
