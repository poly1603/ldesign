...
exports.FORMAT_PERFORMANCE = exports.FORMAT_VALIDATION_RULES = exports.FORMAT_SPECIFIC_OPTIONS = exports.LIBRARY_TYPE_FORMATS = exports.FORMAT_COMBINATIONS = exports.FORMAT_PRIORITY = exports.FORMAT_USE_CASES = exports.FORMAT_COMPATIBILITY = exports.FORMAT_FILE_PATTERNS = exports.FORMAT_EXTENSIONS = exports.FORMAT_DESCRIPTIONS = exports.FORMAT_ALIASES = exports.OUTPUT_FORMATS = void 0;
/**
 * 支持的输出格式
 */
exports.OUTPUT_FORMATS = ['esm', 'cjs', 'umd', 'iife'];
/**
 * 格式别名映射
 */
exports.FORMAT_ALIASES = {
    'es': 'esm',
    'es6': 'esm',
    'module': 'esm',
    'commonjs': 'cjs',
 ...
 * 格式特定的配置选项
 */
exports.FORMAT_SPECIFIC_OPTIONS = {
    esm: {
        // ES Module 特定选项
        exports: 'named',
        interop: 'auto',
 ...
 * 格式验证规则
 */
exports.FORMAT_VALIDATION_RULES = {
    esm: {
        // ES Module 验证规则
