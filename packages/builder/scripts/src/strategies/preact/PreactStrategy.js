...
exports.PreactStrategy = void 0;
const library_1 = require("../../types/library");
const minify_processor_1 = require("../../utils/minify-processor");
class PreactStrategy {
    constructor() {
        this.name = 'preact';
        this.supportedTypes = [library_1.LibraryType.PREACT];
        this.priority = 9;
    }
    ...
    isApplicable(config) {
        return config.libraryType === library_1.LibraryType.PREACT;
    }
    getDefaultConfig() {
        return {
            libraryType: library_1.LibraryType.PREACT,
    ...
    createWarningHandler() {
        return (warning) => { void warning; /* 可按需过滤 */ };
    }
    /**
...
exports.PreactStrategy = PreactStrategy;
