...
class SolidStrategy {
    ...
    isApplicable(config) {
        return config.libraryType === library_1.LibraryType.SOLID;
    }
    getDefaultConfig() {
        return {
            libraryType: library_1.LibraryType.SOLID,
...
exports.SolidStrategy = SolidStrategy;
