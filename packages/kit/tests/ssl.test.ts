...
describe('SSLManager', () => {
  ...
  describe('证书生成', () => {
    it('应该能够生成自签名证书', async () => {
      ...
      const certificate = await sslManager.generateSelfSignedCertificate(mockKeyPair, certificateRequest)
...
describe('SSLUtils', () => {
  describe('快速证书生成', () => {
    it('应该能够快速生成自签名证书', async () => {
      ...
      vi.spyOn(SSLManager.prototype, 'generateSelfSignedCertificate').mockImplementation(mockGenerateCertificate)
