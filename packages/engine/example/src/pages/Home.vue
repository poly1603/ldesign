  ...
  <div class="home-page">
    <header class="hero-section">
      <div class="hero-content">
        <h1 class="hero-title">🚀 Vue3 Engine</h1>
        <p class="hero-subtitle">强大的Vue3应用引擎 - 插件化、中间件、全局管理</p>
      ...
      <div class="container">
        ...
        <div class="features-grid">
          <div class="feature-card" @click="navigateTo('plugin')">
            ...
            <p class="feature-description">灵活的插件架构，支持依赖管理和生命周期控制</p>
          ...
          <div class="feature-card" @click="navigateTo('event')">
            <div class="feature-icon">📡</div>
            <h3 class="feature-title">事件系统</h3>
            <p class="feature-description">高效的事件管理，支持优先级和命名空间</p>
            <div class="feature-stats">
          ...
          <div class="feature-card" @click="navigateTo('state')">
            <div class="feature-icon">💾</div>
            <h3 class="feature-title">状态管理</h3>
            <p class="feature-description">响应式状态管理，支持嵌套路径和命名空间</p>
            <div class="feature-stats">
          ...
          <div class="feature-card" @click="navigateTo('middleware')">
            <div class="feature-icon">⚡</div>
            <h3 class="feature-title">中间件</h3>
            <p class="feature-description">强大的中间件系统，支持请求/响应处理</p>
            <div class="feature-stats">
          ...
          <div class="feature-card" @click="navigateTo('logger')">
            <div class="feature-icon">📝</div>
            <h3 class="feature-title">日志系统</h3>
            <p class="feature-description">完整的日志管理，支持多级别和格式化</p>
            <div class="feature-stats">
          ...
          <div class="feature-card" @click="navigateTo('notification')">
            ...
            <p class="feature-description">美观的通知提示，支持多种类型</p>
            <div class="feature-stats">
              <span>实时通知</span>
            </div>
          </div>
