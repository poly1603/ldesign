...
export {
  ...
  watchSystemTheme,
} from './core/system-theme-detector.js'
export {
  createCustomTheme,
  cyanTheme,
  darkTheme,
 ...
 * @returns 主题管理器实例
 */
declare function createThemeManagerWithPresets(
  options?: ThemeManagerOptions
 ...
 * @returns 主题管理器实例
 */
declare function createSimpleThemeManager(
  options?: ThemeManagerOptions
): Promise<ThemeManagerInstance>
/**
 * 创建自定义主题管理器
 ...
 * @returns 主题管理器实例
 */
declare function createCustomThemeManager(
  primaryColor: string,
  options?: ThemeManagerOptions & {
    themeName?: string
