 ...
 * 创建闲时处理器实例
 */
declare function createIdleProcessor(
 ...
 * 便捷函数：创建延迟执行的闲时任务
 */
declare function createDelayedIdleTask(
  task: () => void | Promise<void>,
  delay: number,
  priority?: number
): void
 ...
 * 便捷函数：创建条件执行的闲时任务
 */
declare function createConditionalIdleTask(
  condition: () => boolean,
  task: () => void | Promise<void>,
  priority?: number
): void
