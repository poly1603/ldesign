import { CSSInjector, ColorCategory, ColorScale, ColorValue } from '../core/types.js';
...
declare class CSSVariableGenerator {
     ...
     * 从色阶生成 CSS 变量
     */
    generateFromScales(scales: Record<ColorCategory, ColorScale>, prefix?: string): Record<string, ColorValue>;
    /**
     * 生成语义化 CSS 变量
     */
    generateSemanticVariables(scales: Record<ColorCategory, ColorScale>, prefix?: string): Record<string, ColorValue>;
    /**
     * 更新前缀
     */
 ...
 * 便捷函数：直接注入色阶变量
 */
declare function injectScaleVariables(scales: Record<ColorCategory, ColorScale>, options?: CSSInjectionOptions & {
    prefix?: string;
    semantic?: boolean;
}): void;
/**
