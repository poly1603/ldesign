 ...
 * 创建系统主题检测器
 */
declare function createSystemThemeDetector(type?: 'browser' | 'manual', options?: SystemThemeDetectorOptions): SystemThemeDetector;
/**
 * 默认浏览器系统主题检测器实例
 */
 ...
 * 便捷函数：监听系统主题变化
 */
declare function watchSystemTheme(callback: (mode: ColorMode) => void): () => void;
/**
 * 便捷函数：检查是否支持系统主题检测
 */
...
export { BrowserSystemThemeDetector, ManualSystemThemeDetector, browserDetector, createSystemThemeDetector, createThemeMediaQuery, getSystemTheme, isSystemThemeSupported, watchSystemTheme };
