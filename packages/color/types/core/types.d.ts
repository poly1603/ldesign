 ...
 * 主题管理器实例接口
 */
interface ThemeManagerInstance extends EventEmitter {
    /** 初始化 */
    init: () => Promise<void>;
    /** 获取当前主题名称 */
 ...
 * 事件类型
 */
type ThemeEventType = 'theme-changed' | 'mode-changed' | 'theme-registered' | 'theme-generated' | 'error';
/**
 * 事件监听器
 */
