 ...
 * 创建自定义主题配置
 */
declare function createCustomTheme(name: string, primaryColor: string, options?: {
    displayName?: string;
    description?: string;
...
declare const themeCategories: {
    ...
    /** 彩色主题 */
    readonly colorful: readonly [ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig];
    /** 所有主题 */
 ...
 * 按分类获取主题
 */
declare function getThemesByCategory(category: keyof typeof themeCategories): ThemeConfig[];
/**
 * 主题标签
 */
declare const themeTags: {
    readonly professional: readonly [ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig];
    readonly vibrant: readonly [ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig];
    ...
    readonly classic: readonly [ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig];
    readonly natural: readonly [ThemeConfig, ThemeConfig, ThemeConfig];
    readonly elegant: readonly [ThemeConfig, ThemeConfig, ThemeConfig, ThemeConfig];
};
/**
 * 按标签获取主题
 */
...
export { createCustomTheme, cyanTheme, darkTheme, defaultTheme, getPresetTheme, getPresetThemeNames, getRandomPresetTheme, getThemesByCategory, getThemesByTag, greenTheme, isPresetTheme, minimalTheme, orangeTheme, pinkTheme, presetThemes, purpleTheme, recommendThemes, redTheme, themeCategories, themeTags, yellowTheme };
