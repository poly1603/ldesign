      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'SSR 指南', link: '/guide/ssr' },
            { text: '作用域主题', link: '/guide/scoped-theming' },
            { text: 'Constructable Stylesheet', link: '/guide/constructable-stylesheet' },
            { text: '可访问性与高对比度', link: '/guide/accessibility' },
          ],
        },
      ],
      '/api/': [
