...
export class ColorHarmonyAnalyzer {
  ...
  private detectHarmonyType(colors: HSL[]): HarmonyType {
    ...
    if (this.hasComplementary(angles))
      return 'complementary'
    if (this.hasTriadic(angles))
      return 'triadic'
    if (this.hasTetradic(angles))
      return 'tetradic'
    if (this.hasAnalogous(angles))
      return 'analogous'
    if (this.hasSplitComplementary(angles))
