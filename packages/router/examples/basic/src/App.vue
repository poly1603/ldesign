<template>
  <div id="app">
    <header class="header">
      <h1>LDesign Router - Basic Example</h1>
      <p>A simple demonstration of @ldesign/router functionality</p>
    </header>
    ...
    <nav class="nav">
      ...
      <RouterLink to="/products?category=electronics">Products</RouterLink>
      <RouterLink to="/contact#form">Contact</RouterLink>
    </nav>
