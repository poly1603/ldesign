 ...
 * 虚拟列表状态
 */
interface VirtualListState<T = any> {
    /** 可见的项目列表 */
 ...
 * ```
 */
declare function useVirtualList<T = any>(data: Ref<T[]>, config: VirtualListConfig): {
    state: Ref<VirtualListState<T>>;
    actions: VirtualListActions;
    containerProps: vue.ComputedRef<{
...
export type { VirtualListActions, VirtualListConfig, VirtualListItem, VirtualListState };
