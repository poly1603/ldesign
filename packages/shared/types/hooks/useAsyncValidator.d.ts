 ...
 * 异步验证函数类型
 */
export type AsyncValidatorFunction<T = any> = (value: T, signal?: AbortSignal) => Promise<string | true>;
/**
 * 异步验证配置
 */
 ...
 * ```
 */
export declare function useAsyncValidator<T>(value: Ref<T>, config: AsyncValidatorConfig<T>): {
 ...
 * ```
 */
export declare function useMultiAsyncValidator<T extends Record<string, any>>(validators: {
    [K in keyof T]: {
        value: () => T[K];
...
//# sourceMappingURL=useAsyncValidator.d.ts.map