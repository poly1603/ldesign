 ...
 * 验证规则类型
 */
type ValidatorFunction<T = any> = (value: T, formData?: Record<string, any>) => string | Promise<string> | true | Promise<true>;
/**
 * 内置验证规则
 */
 ...
 * 验证规则配置
 */
interface ValidationRule extends BuiltInRules {
    /** 自定义验证函数 */
 ...
 * ```
 */
declare function useFormValidation<T extends Record<string, any>>(formData: T, config: Record<keyof T, FieldValidationConfig>): {
...
export type { BuiltInRules, FieldValidationConfig, FormValidationState, ValidationRule, ValidationState, ValidatorFunction };
