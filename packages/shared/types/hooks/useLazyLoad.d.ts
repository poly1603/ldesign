 ...
 * ```
 */
export declare function useLazyLoad(target: Ref<Element | null>, config?: LazyLoadConfig): {
    state: import("vue").ComputedRef<LazyLoadState>;
    restart: () => void;
    startObserving: () => void;
    stopObserving: () => void;
};
 ...
 * ```
 */
export declare function useImageLazyLoad(config?: {
    placeholder?: string;
    rootMargin?: string;
    threshold?: number;
    onLoad?: () => void;
 ...
 * ```
 */
export declare function useBatchLazyLoad<T>(items: Ref<T[]>, config?: LazyLoadConfig & {
    onItemEnter?: (item: T, index: number) => void;
    onItemLeave?: (item: T, index: number) => void;
}): {
    states: import("vue").ComputedRef<{
        isVisible: boolean;
        hasEntered: boolean;
        isSupported: boolean;
        entry: {
