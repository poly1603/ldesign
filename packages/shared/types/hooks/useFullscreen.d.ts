 ...
 * ```
 */
declare function useFullscreen(target?: Ref<Element | null> | Element | null, config?: FullscreenConfig): {
    state: vue.ComputedRef<FullscreenState>;
 ...
 * ```
 */
declare const enterFullscreen: (element?: Element) => Promise<boolean>;
/**
 * 退出全屏
 *
 * @returns 是否成功退出全屏
 ...
 * ```
 */
declare const exitFullscreen: () => Promise<boolean>;
/**
 * 切换全屏状态
 *
 * @param element - 要全屏的元素（可选）
 ...
 * ```
 */
declare const toggleFullscreen: (element?: Element) => Promise<boolean>;
/**
 * 检查全屏支持性
 *
 * @returns 是否支持全屏
 ...
 * ```
 */
declare const getCurrentFullscreenElement: () => Element | null;
/**
 * 检查是否处于全屏状态
 *
 * @returns 是否处于全屏状态
 ...
 * ```
 */
declare const isCurrentlyFullscreen: () => boolean;
...
export type { FullscreenConfig, FullscreenState };
