 ...
 * ```
 */
export declare function useClipboard(config?: ClipboardConfig): {
    state: import("vue").ComputedRef<ClipboardState>;
 ...
 * ```
 */
export declare const copyToClipboard: (text: string, config?: ClipboardConfig) => Promise<boolean>;
/**
 * 读取剪贴板内容
 *
 * @returns 剪贴板文本内容
 ...
 * ```
 */
export declare const readFromClipboard: () => Promise<string>;
/**
 * 检查剪贴板支持性
 *
 * @returns 支持性信息
 ...
 * ```
 */
export declare const checkClipboardSupport: () => {
    copy: boolean;
    read: boolean;
    legacy: boolean;
};
