 ...
 * 元素交叉状态
 */
interface ElementIntersectionState {
    /** 是否可见 */
 ...
 * ```
 */
declare function useIntersectionObserver(config?: IntersectionObserverConfig): {
    state: vue.ComputedRef<IntersectionObserverState>;
 ...
 * ```
 */
declare function useElementIntersectionObserver(target: Ref<Element | null>, config?: IntersectionObserverConfig & {
    onIntersect?: (entry: IntersectionObserverEntry) => void;
    onEnter?: (entry: IntersectionObserverEntry) => void;
    onLeave?: (entry: IntersectionObserverEntry) => void;
}): {
    state: vue.ComputedRef<ElementIntersectionState>;
    start: () => void;
    stop: () => void;
    observerState: vue.ComputedRef<IntersectionObserverState>;
};
/**
 * 可见性检测 Hook
 *
 ...
 * ```
 */
declare function useVisibility(target: Ref<Element | null>, config?: IntersectionObserverConfig & {
    visibilityThreshold?: number;
}): {
    isVisible: vue.ComputedRef<boolean>;
    visibilityRatio: vue.ComputedRef<number>;
    state: vue.ComputedRef<ElementIntersectionState>;
};

export { useElementIntersectionObserver, useIntersectionObserver, useVisibility };
export type { ElementIntersectionState, IntersectionObserverConfig, IntersectionObserverState };
