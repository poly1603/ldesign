 ...
 * ```
 */
declare function useDarkMode(config?: DarkModeConfig): {
    state: vue.ComputedRef<DarkModeState>;
    toggle: () => Promise<void>;
 ...
 * ```
 */
declare function useSimpleDarkMode(): {
 ...
 * ```
 */
declare function getSystemThemePreference(): boolean;
/**
 * 监听系统主题变化
 *
 ...
 * ```
 */
declare function watchSystemTheme(callback: (prefersDark: boolean) => void): () => void;

export { getSystemThemePreference, useDarkMode, useSimpleDarkMode, watchSystemTheme };
export type { DarkModeConfig, DarkModeState, ThemeMode };
