 ...
 * ```
 */
declare function useDebounceValue<T>(value: Ref<T>, delay: number): Ref<T>;
/**
 * 防抖函数 Hook
 *
 * @param fn - 要防抖的函数
 ...
 * ```
 */
declare function useDebounceFunction<T extends (...args: any[]) => any>(fn: T, delay: number, immediate?: boolean): [T, () => void];
/**
 * 节流值 Hook
 *
 ...
 * ```
 */
declare function useThrottleValue<T>(value: Ref<T>, delay: number): Ref<T>;
/**
 * 节流函数 Hook
 *
 * @param fn - 要节流的函数
 ...
 * ```
 */
declare function useThrottleFunction<T extends (...args: any[]) => any>(fn: T, delay: number): T;
/**
 * 组合防抖和节流 Hook
 *
 ...
 * ```
 */
declare function useDebounceThrottle<T>(value: Ref<T>, debounceDelay: number, throttleDelay: number): Ref<T>;

export { useDebounceFunction, useDebounceThrottle, useDebounceValue, useThrottleFunction, useThrottleValue };
