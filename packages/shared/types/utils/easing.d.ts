 ...
 * ```
 */
declare function getEasingFunction(name: EasingName): EasingFunction;
/**
 * 创建动画帧函数
 *
 * @param from - 起始值
 ...
 * ```
 */
declare function animate(from: number, to: number, duration: number, easing: EasingName | EasingFunction, onUpdate: (value: number) => void, onComplete?: () => void): () => void;

export { animate, easeInBack, easeInCubic, easeInElastic, easeInOutCubic, easeInOutQuad, easeInQuad, easeOutBack, easeOutBounce, easeOutCubic, easeOutElastic, easeOutQuad, easingFunctions, getEasingFunction, linear };
