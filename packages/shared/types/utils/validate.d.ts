 ...
 * ```
 */
declare function isValidLandline(phone: string): boolean;
/**
 * 验证中国大陆邮政编码
 *
 * @param zipCode - 邮政编码
 ...
 * ```
 */
declare function isValidSocialCreditCode(code: string): boolean;

export { isValidBankCard, isValidEmail, isValidIPv4, isValidIPv6, isValidIdCard, isValidLandline, isValidPhone, isValidSocialCreditCode, isValidUrl, isValidZipCode, validatePassword };
