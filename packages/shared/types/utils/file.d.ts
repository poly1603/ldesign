 ...
 * ```
 */
declare function getFileType(filename: string): string;
/**
 * 验证文件类型
 *
 * @param file - 文件对象
 ...
 * ```
 */
declare function downloadFile(data: string | Blob | ArrayBuffer, filename: string, mimeType?: string): void;
/**
 * 压缩图片
 *
 * @param file - 图片文件
 ...
 * ```
 */
declare function selectFiles(config?: FileUploadConfig): Promise<File[]>;
/**
 * 数组转CSV
 *
 * @param data - 数据数组
 ...
 * ```
 */
declare function arrayToCSV(data: Record<string, any>[], options?: {
    headers?: string[];
    delimiter?: string;
 ...
 * ```
 */
declare function csvToArray(csv: string, options?: {
    delimiter?: string;
    hasHeaders?: boolean;
    headers?: string[];
 ...
 * ```
 */
declare function exportCSV(data: Record<string, any>[], filename: string, options?: Parameters<typeof arrayToCSV>[1]): void;
/**
 * 获取文件的Base64编码
 *
 * @param file - 文件对象
 ...
 * ```
 */
declare function getFileBase64(file: File): Promise<string>;

export { arrayToCSV, compressImage, csvToArray, downloadFile, exportCSV, getFileBase64, getFileExtension, getFileType, readFile, selectFiles, validateFileSize, validateFileType };
