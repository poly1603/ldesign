 ...
 * ```
 */
declare function interpolate(template: string, data: Record<string, any>): string;

export { capitalize, escapeHtml, formatFileSize, interpolate, isValidEmail, isValidUrl, randomString, stripHtml, toCamelCase, toKebabCase, toPascalCase, toSnakeCase, truncate, unescapeHtml };
