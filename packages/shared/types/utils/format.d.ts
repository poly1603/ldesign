 ...
 * ```
 */
declare function formatPercentage(value: number, options?: Omit<NumberFormatOptions, 'useGrouping'>): string;
/**
 * 格式化文件大小
 *
 * @param bytes - 字节数
 ...
 * ```
 */
declare function formatFileSize(bytes: number, options?: {
    decimals?: number;
    binary?: boolean;
    locale?: string;
}): string;
 ...
 * ```
 */
declare function formatCompactNumber(value: number, options?: {
    locale?: string;
    notation?: 'short' | 'long';
    maximumFractionDigits?: number;
}): string;
 ...
 * ```
 */
declare function formatDuration(seconds: number, options?: {
 ...
 * ```
 */
declare function formatRelativeTime(date: Date, options?: {
    locale?: string;
    baseDate?: Date;
}): string;

export { formatCompactNumber, formatCurrency, formatDuration, formatFileSize, formatNumber, formatPercentage, formatRelativeTime };
