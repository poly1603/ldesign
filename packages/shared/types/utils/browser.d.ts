 ...
 * ```
 */
export declare function setStorage(key: string, value: any, options?: {
    expires?: number;
 ...
 * @returns 存储值或 null
 */
export declare function getStorage(key: string, options?: {
    storage?: 'localStorage' | 'sessionStorage';
}): any;
/**
 * 删除本地存储
 ...
 * @param options - 配置选项
 */
export declare function removeStorage(key: string, options?: {
    storage?: 'localStorage' | 'sessionStorage';
}): void;
/**
 * 清空本地存储
 ...
 * @param options - 配置选项
 */
export declare function clearStorage(options?: {
    storage?: 'localStorage' | 'sessionStorage';
}): void;
/**
 * 获取 URL 参数
 ...
 * ```
 */
export declare function setUrlParams(params: Record<string, string | number | boolean>, options?: {
    replace?: boolean;
    baseUrl?: string;
}): void;
/**
 ...
 * @param options - 配置选项
 */
export declare function removeUrlParams(keys: string | string[], options?: {
    replace?: boolean;
}): void;
/**
 * 获取设备信息
 ...
 * ```
 */
export declare function getBrowserSupport(): {
 ...
 * ```
 */
export declare function getPageVisibility(): boolean;
/**
 * 监听页面可见性变化
 *
 * @param callback - 回调函数
 ...
 * ```
 */
export declare function watchPageVisibility(callback: (isVisible: boolean) => void): () => void;
