 ...
 * ```
 */
declare function formatDate(date: Date | string | number, format: string | DateFormatOptions, locale?: string): string;
/**
 * 解析日期字符串
 *
 ...
 * ```
 */
declare function dateDiff(date1: Date | string | number, date2: Date | string | number, unit?: 'years' | 'months' | 'days' | 'hours' | 'minutes' | 'seconds' | 'milliseconds'): number;
/**
 * 添加时间到日期
 *
 * @param date - 基础日期
 ...
 * ```
 */
declare function addTime(date: Date | string | number, amount: number, unit: 'years' | 'months' | 'days' | 'hours' | 'minutes' | 'seconds' | 'milliseconds'): Date;
/**
 * 减去时间从日期
 *
 * @param date - 基础日期
 ...
 * ```
 */
declare function subtractTime(date: Date | string | number, amount: number, unit: 'years' | 'months' | 'days' | 'hours' | 'minutes' | 'seconds' | 'milliseconds'): Date;
/**
 * 获取日期的开始时间
 *
 * @param date - 日期
 ...
 * ```
 */
declare function startOf(date: Date | string | number, unit: 'year' | 'month' | 'day' | 'hour' | 'minute' | 'second'): Date;
/**
 * 获取日期的结束时间
 *
 * @param date - 日期
 ...
 * ```
 */
declare function endOf(date: Date | string | number, unit: 'year' | 'month' | 'day' | 'hour' | 'minute' | 'second'): Date;
/**
 * 检查是否为闰年
 *
 * @param year - 年份
 ...
 * ```
 */
declare function timeAgo(date: Date | string | number, baseDate?: Date, locale?: string): string;

export { addTime, dateDiff, endOf, formatDate, getDaysInMonth, isLeapYear, parseDate, startOf, subtractTime, timeAgo };
