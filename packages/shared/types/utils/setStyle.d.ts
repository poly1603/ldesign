 ...
 * ```
 */
export declare function setStyle(el: HTMLElement, styles: Styles): void;
/**
 * 获取元素的计算样式值
 *
 * @param el - 目标 HTML 元素
 ...
 * ```
 */
export declare function getComputedStyleValue(el: HTMLElement, property: string): string;
/**
 * 移除元素的指定样式属性
 *
 * @param el - 目标 HTML 元素
 ...
 * ```
 */
export declare function removeStyle(el: HTMLElement, properties: string[]): void;
/**
 * 切换元素的样式类
 *
 * @param el - 目标 HTML 元素
