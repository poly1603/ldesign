...
import { InjectionKey, App } from '../node_modules/.pnpm/@vue_runtime-core@3.5.18/node_modules/@vue/runtime-core/dist/runtime-core.d.js';
 ...
 * 使用 API 引擎的组合式函数
 */
declare function useApi(injectionKey?: InjectionKey<ApiEngine> | string | symbol): ApiEngine;
/**
 * 创建 API 引擎提供者
 */
declare function createApiProvider(config?: ApiEngineConfig, injectionKey?: InjectionKey<ApiEngine> | string | symbol): {
    apiEngine: ApiEngine;
    provide: () => void;
    use: () => ApiEngine;
};
