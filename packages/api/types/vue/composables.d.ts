 ...
 * 使用 API 调用的组合式函数
 */
declare function useApiCall<T = unknown, P extends Record<string, unknown> | undefined = Record<string, unknown>>(methodName: string, options?: UseApiCallOptions): ApiCallState<T>;
/**
 * 使用系统 API 的组合式函数
 */
 ...
 * 批量 API 调用的组合式函数
 */
declare function useBatchApiCall<T = unknown>(methodNames: string[], _options?: UseApiCallOptions): {
